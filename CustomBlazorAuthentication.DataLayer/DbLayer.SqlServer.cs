...
{
    public class SqlServerDbLayer: DbLayer
    {
        #region Constructor
        /// <summary>
        /// Constructor
        ...
        public SqlServerDbLayer(string connectionString)
        {
        ...
        {
            return users.FirstOrDefault(obj => obj.UserName.Equals(userName, StringComparison.InvariantCultureIgnoreCase));
        }
        /// <summary>
        /// Insert user
        /// </summary>
